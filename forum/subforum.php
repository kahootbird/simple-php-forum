...
<div class="jumbotron">
	...
	$query = 'select * from thread where categoryid = ' . $ID . ' order by threadid';
	...
	<a href="thread.php?id=<?php echo $categories['threadid']; ?>&Data=<?php echo $categories['categoryid'];?>" class="thumbnail">
	...
	?>
	   <div class='jumbotron'>
	   <a href='Create_Post.php?id=<?php echo $ID ?>'>
Create Post
</a>
</div>
	</br>
